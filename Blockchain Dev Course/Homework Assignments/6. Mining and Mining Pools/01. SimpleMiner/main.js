...
var getGenesisBlock = () => {
    return new Block(0, "0", 1465154705, "the genesis block", "816534932c2b7154836da6afc367695e6337db8a921823784c14378abed4f7d7", 0, 0);
};
...
var mineBlock = (blockData) => {
    ...
    while(nextHash.substring(0, difficulty) !== Array(difficulty + 1).join("0")){
        ...
        console.log("index: " + nextIndex + ", previousHash: " + previousBlock.hash +
                    ...
                    ", \x1b[36mhash: " + nextHash + "\x1b[0m" + ", difficulty: " + difficulty +
                    ", \x1b[36mnonce: " + nonce + "\x1b[0m");
    }
